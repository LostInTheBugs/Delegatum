#!/usr/bin/env python3
"""Génère desktop/delegatum.icns (icône macOS) depuis l'emblème du projet.

Recette (alignée sur l'icône Windows desktop/delegatum.ico) : canevas carré
...
Source : frontend/public/delegatum-icon.png (emblème du projet).
"""
import shutil
import subprocess
import tempfile
...
SRC = ROOT / "frontend" / "public" / "delegatum-icon.png"
OUT = ROOT / "desktop" / "delegatum.icns"
